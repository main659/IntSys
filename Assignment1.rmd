...
*Feature selection was succesful. We managed to reduce the number of features by 0.59, reducing the original set of 1070 features to 440 with no significant accuracy loss.*

###The procedure might overfit the data set. How would you prevent it?

*Overfitting is a natural and unavoidable process while training a model and the general solution is splitting the data into a training and test set. The dataset was split 0.8 Training set and 0.2 Test set.*
...
*Some of the key properties of the fitness function are very negative values for to many or two few features, binarity of input, convexness within boundaries, ...*
