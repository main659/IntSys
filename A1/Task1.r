...
p1mat <- persp(x,y,z, col="lightblue", theta=110, phi=5, main="\ngareal_blxCrossover, pmutation=0.1")
...
p2mat <- persp(x,y,z, col="lightblue", theta=110, phi=5, main="\ngareal_blxCrossover, pmutation=0.5")
...
p3mat <- persp(x,y,z, col="lightblue", theta=110, phi=5, main="\ngareal_laplaceCrossover, pmutation=0.1")
...
p4mat <- persp(x,y,z, col="lightblue", theta=110, phi=5, main="\ngareal_laplaceCrossover, pmutation=0.5")
